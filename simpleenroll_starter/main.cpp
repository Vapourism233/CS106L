...
std::string COURSES_PATH = "/Users/apple/Desktop/cs106L/simpleenroll_starter/courses.csv";
...
int main() {
  ...
  vector_of_courses = parse_csv(COURSES_PATH, vector_of_courses);
  std::cout << "vector_of_courses.size() = " << vector_of_courses.size() << '\n';
